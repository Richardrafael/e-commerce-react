      ...
      {items
        ? items.map((item) => (
            <div key={item.id} className="flex justify-center">
              <div className="w-[280px] h-[230px] border border-green-200 bg-white/80 rounded-xl flex flex-col justify-between text-black hover:bg-white/90 hover:text-black hover:font-medium transition duration-200">
                <div>
